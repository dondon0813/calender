...
function switchView(name, target) {
  ...
  const VIEW_PERM_KEY = { accounting: 'revenue|commission|acctRecon', books: 'bookEdit', cardSub: 'cardSubEdit', recipeDb: 'recipeEdit', schoolList: 'schoolEdit', blog: 'blogEdit', fanAdmin: 'fanEdit' };
