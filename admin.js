...
function switchView(name, target) {
  ...
  const VIEW_PERM = { imageLibrary: '圖片庫', report: '報表統計', accounting: '開團帳務', contractSign: '線上合約用印', books: '繪本後台', recipeDb: '食譜資料庫', schoolList: '開學清單', blog: '文章管理', fanAdmin: '會員管理', hall: '教材館', changelog: '更新日誌' };
  const VIEW_PERM_KEY = { accounting: 'revenue|commission|acctRecon|lotteryEdit', books: 'bookEdit', cardSub: 'cardSubEdit', recipeDb: 'recipeEdit', schoolList: 'schoolEdit', blog: 'blogEdit', fanAdmin: 'fanEdit', hall: 'bookEdit', changelog: 'changelogEdit' };
