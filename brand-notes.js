/* ============================================================
   品牌小備註庫（calendar-poster.html 的貼文文案用）——備援快照
   ------------------------------------------------------------
   ⚠ 2026-08-29 起正本改存新後端資料庫（brand_post_notes 表，
   migration 20260829000002 已把這裡全部 44 筆 seed 進去）。
   calendar-poster.html 開站會抓 ?scope=brandnotes 蓋過這份清單，
   要新增／修改備註直接在貼文產生器打字按「☁️ 同步新備註到系統」即可；
   這個檔只在後端讀不到（斷網／表未建）時當備援，不再手動維護。
